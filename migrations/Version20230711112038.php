 ...
 */
final class Version20230711112038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE images ADD car_id_id INT DEFAULT NULL, DROP car_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE images ADD car_id INT NOT NULL, DROP car_id_id');
