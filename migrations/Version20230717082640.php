 ...
 */
final class Version20230717082640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hours CHANGE morning_open_hours morning_open_hours VARCHAR(20) NOT NULL, CHANGE morning_close_hours morning_close_hours VARCHAR(20) NOT NULL, CHANGE afternoon_open_hours afternoon_open_hours VARCHAR(20) NOT NULL, CHANGE afternoon_close_hours afternoon_close_hours VARCHAR(20) NOT NULL');
    }
